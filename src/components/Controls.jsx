    ...
    return (
        <>
            <Segment inverted>
                <div className="balance">
                    <Label image size="huge" color="black">
                        <span className="counter" data-count={balance}>{doCurrency(balance)}</span>
                ...
                <div className="flexcontrol">
                    ...
                    <div className="boxcontrol">
                        <Label image size="huge" color="teal">
                            <span className="counter" data-count={bet * line}>0</span>
            ...
            <div className="flexcontrol bottomControll">
                ...
                <div className="boxcontrol">
                    <LinesButtons valFunc={bet} setFunc={setBet} valSum={5000} min={5000} max={5000 * 20} text={"Bet"} color="purple" id="betval" />
...
<ButtonGroup size="huge" color={color}>
    ...
    <Button basic inverted  color={color}  onClick={() => setFunc(valFunc >= max?min:max)} >{text}: <span className="counter" data-count={valFunc}></span> <span id={id} style={{ display: 'none' }}>{valFunc}</span></Button>
